...
-- auto-generated definition
create table shop_one_goods_top_month
(
    id          int auto_increment comment 'id'
        primary key,
    shop_id     bigint       null comment '商铺ID',
...
create index dt
    on shop_one_goods_top_month (dt);

-- auto-generated definition
create table shop_one_goods_info_month
(
    id                  int auto_increment comment 'id'
        primary key,
    shop_id             bigint         null comment '商铺ID',
...
create index dt
    on shop_one_goods_info_month (dt);

-- auto-generated definition
create table shop_one_goods_newputaway_month
(
    id          int auto_increment comment 'id'
        primary key,
    shop_id     bigint       null comment '商铺ID',
...
create index dt
    on shop_one_goods_newputaway_month (dt);