...
(
    shop_id           bigint,
    pick_number       bigint comment '自提点数',
    pick_order_number      bigint comment '自提点订单数',
    pick_order_money  decimal(12, 2) comment '自提点订单金额',
    pick_income_money decimal(12, 2) comment '自提点收入',
    dt                date,
    constraint shop_deal_info_pk
        unique (shop_id, dt)
);